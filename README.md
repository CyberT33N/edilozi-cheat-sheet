...
```typescript
import Buttons from "@/components/edil-ozi/buttons";
...
# Base Input
- https://www.edilozi.pro/docs/components/base-inputs
```typescript
import { FC } from "react";

import BaseInputs from "@/components/edil-ozi/base-inputs";
...
# Canvas Cursor **HOT**
- https://www.edilozi.pro/docs/components/canvas-cursor
```typescript
...
## Fluid Cursor **HOT**
- https://www.edilozi.pro/docs/components/fluid-cursor
```javascript
"use client";
...
## Ink cursor **HOT**
- https://www.edilozi.pro/docs/components/ink-cursor
```javascript
'use client'
